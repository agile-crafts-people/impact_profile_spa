<template>
  <v-container>
    <v-row>
      <v-col>
        <h1 class="text-h4 mb-4">New User</h1>
      </v-col>
    </v-row>
          ...
          <v-card-text>
            <v-form ref="formRef" @submit.prevent="handleSubmit">
              <v-text-field
                ...
                persistent-hint
                required
                data-automation-id="user-new-name-input"
              />
              ...
              <v-textarea
                ...
                rows="3"
                class="mt-4"
                data-automation-id="user-new-description-input"
              />
              ...
              <v-select
                ...
                :items="statusOptions"
                class="mt-4"
                data-automation-id="user-new-status-select"
              />
              ...
              <v-card-actions class="px-0 mt-4">
                <v-btn 
                  @click="router.back()" 
                  variant="text"
                  data-automation-id="user-new-cancel-button"
                >
                  Cancel
                </v-btn>
                <v-spacer />
                <v-btn
                  ...
                  :loading="isPending"
                  :disabled="isPending"
                  data-automation-id="user-new-submit-button"
                >
                  Create User
                </v-btn>
              </v-card-actions>
...
const { mutate: createUser, isPending } = useMutation<{ _id: string }, Error, UserInput>({
